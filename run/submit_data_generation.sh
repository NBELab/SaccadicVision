...
#SBATCH --job-name=data_generation               # Name of the job (can be customized, here it's 'FOO')
...
source ../myenv/bin/activate         # Activate your custom environment (path to the environment)

## Run the Python script

python ../data_generation.py                       # Run the main Python script
